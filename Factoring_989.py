...
if __name__ == '__main__':
    ...
    #  对乘法表每一行进行输入，这里还可以改进
    p = [0, 0, 0, 0, 1, p4, p3, p2, p1, 1]
    q = [0, 0, 0, 0, 0, 1, q3, q2, q1, 1]
    product_terms1 = [0, 0, 0, 0, 1, p4, p3, p2, p1, 1]
    product_terms2 = [0, 0, 0, q1,	p4*q1,	p3*q1,	p2*q1,	p1*q1,	q1, 0]
    product_terms3 = [0, 0, q2,	p4*q2,	p3*q2,	p2*q2,	p1*q2,	q2, 0, 0]
    product_terms4 = [0, q3, p4*q3,	p3*q3,	p2*q3,	p1*q3,	q3, 0, 0, 0]
    product_terms5 = [1, p4, p3, p2, p1, 1, 0, 0, 0, 0]
    carries = [c5, c4, c3, 0, c2, c1, 0, 0, 0, 0]
    ...
    # 对整个乘法表进行分块
    left0, cols0 = np.split(A1, [9], axis=1)  # 分出第一块
    left1, cols1 = np.split(left0, [6], axis=1)  # 分出第二块
